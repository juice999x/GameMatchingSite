                        ...
                        <form action="/matching/edit/{{ $users->id }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mt-8 grid lg:grid-cols-1 gap-4">
                                ...
                                <div>
                                    ...
                                    <textarea type="text" name="user[easy_introduction]" id="bio" class="bg-gray-100 border border-gray-200 rounded py-3 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full"></textarea>
                                </div>
                            </div>
                            <div class="space-x-4 mt-8">
                                <button type="submit" class="py-2 px-4 bg-blue-500 text-white rounded hover:bg-blue-600 active:bg-blue-700 disabled:opacity-50">保存する</button>
                            </div>
                        </form>
                    </div>
                </div>
