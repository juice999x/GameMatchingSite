                ...
                <div class="p-4 text-black">
                    <div class="p-8 rounded border border-gray-200">
                        <div class="flex items-center space-x-4">
                            ...
                            <button onclick="location.href='#'" class="py-3 px-5 bg-white text-white rounded hover:bg-gray-400 active:bg-gray-500 disabled:opacity-50">
                        ...
                        <div class="mt-8 grid lg:grid-cols-1 gap-4">
                            ...
                            <div>
                                ...
                                <h1 class="font-medium text-2xl">{{ $user->sex }}</h1>
                            </div>
                            <div>
                                <label for="birthday" class="text-sm text-gray-700 font-medium">誕生日</label>
                                <h1 class="font-medium text-2xl">{{ $user->birthday }}</h1>
                            </div>
                            <div>
                                <label for="game" class="text-sm text-gray-700 font-medium">好きなゲーム</label>
                                <h1 class="font-medium text-2xl">{{ $user->game }}</h1>
                            </div>
                            <div>
                                <label for="bio" class="text-sm text-gray-700 font-medium">1言コメント</label>
                                <h1 class="font-medium text-2xl">{{ $user->easy_introduction }}</h1>
                            </div>
                            <div class="space-x-4 mt-8">
                                <button onclick="location.href='/matching/{{ $user->id }}/edit'" class="py-2 px-4 bg-blue-500 text-white rounded hover:bg-blue-600 active:bg-blue-700 disabled:opacity-50">編集する</button>
                            </div>
                        </div>
                    </div>
                </div>
