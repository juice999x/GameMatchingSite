...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    　　　　　　//ゲストbladeのロゴコード
        ...
        <div class="flex">
                                        <input type="button" onclick="like({{$timeline->id}})">
                                            <input type="checkbox" id="choose-me" class="peer hidden" />
                                            <label for="choose-me" class="select-none cursor-pointer rounded-lg
                                                py-1 px-2 font-bold transition-colors duration-0 ease-in-out peer-checked:bg-blue-600 peer-checked:text-pink-700 peer-checked:border-blue-200">
